...
public class Main {
    public static void main(String[] args) {
        // 面向切面编程(AOP): 是对面向对象编程的补充,减少代码的冗余
        ...
        // 7.引入(Introduction):再不修改代码的前提下,引入可以在运行期为类动态添加一些方法或字段
        ...
        // pointcut expression: 切入点的表达式,用于匹配指定的连接点(Spring中的连接点都是方法级)
        // bean(bean的id): 通过id找bean中的所有方法
        // execution(访问修饰符,返回值数据类型,方法名(参数类型)): 匹配指定的方法
        // this: 匹配指定的类
        // target: 匹配指定接口的实现类
        // within: 匹配指定包中类
    }
